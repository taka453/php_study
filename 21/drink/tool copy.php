            ...
            if($type === 'add') {
                ...
                if(is_uploaded_file($_FILES['picture']['tmp_name']) === TRUE) {
                    ...
                    if($extension === 'jpg' || $extension === 'jpeg' || $extension === 'png') {
                        ...
                        if(is_file($img_dir . $drink_picure) !== TRUE) {
                ...
                if(count($err_msg) === 0) {
                    ...
                    if(mysqli_query($link, $sql) !== TRUE) {
                        $err_msg[] = 'drink_infomation_table: updateエラー:' . $sql;
                    }
                    if(count($err_msg) === 0) {
                        echo 'ステータス更新成功';
                    }
    ...
    <section>
        ...
        <table>
            ...
            <?php foreach($drink_list as $value) { ?>
                <tr>
                    <td>
                        <img src="<?php echo 'img/' . htmlspecialchars($value['drink_picture'], ENT_QUOTES, 'UTF-8'); ?>" class="img">
                    </td>
